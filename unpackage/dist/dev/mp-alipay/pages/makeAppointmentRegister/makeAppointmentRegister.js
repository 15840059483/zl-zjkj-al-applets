...
/***/ 228:
/*!*************************************************************************************************************************!*\
  !*** C:/Gongzuo/XiaoChengXu/ZhiFuBao/Zjkj/main.js?{"page":"pages%2FmakeAppointmentRegister%2FmakeAppointmentRegister"} ***!
  \*************************************************************************************************************************/
...
var _makeAppointmentRegister = _interopRequireDefault(__webpack_require__(/*! ./pages/makeAppointmentRegister/makeAppointmentRegister.vue */ 229));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/***/ 229:
/*!******************************************************************************************************!*\
  !*** C:/Gongzuo/XiaoChengXu/ZhiFuBao/Zjkj/pages/makeAppointmentRegister/makeAppointmentRegister.vue ***!
  \******************************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _makeAppointmentRegister_vue_vue_type_template_id_32631430_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./makeAppointmentRegister.vue?vue&type=template&id=32631430&scoped=true& */ 230);
/* harmony import */ var _makeAppointmentRegister_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./makeAppointmentRegister.vue?vue&type=script&lang=js& */ 232);
...
/* harmony import */ var _makeAppointmentRegister_vue_vue_type_style_index_0_id_32631430_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./makeAppointmentRegister.vue?vue&type=style&index=0&id=32631430&scoped=true&lang=css& */ 235);
...
/***/ 230:
/*!*************************************************************************************************************************************************!*\
  !*** C:/Gongzuo/XiaoChengXu/ZhiFuBao/Zjkj/pages/makeAppointmentRegister/makeAppointmentRegister.vue?vue&type=template&id=32631430&scoped=true& ***!
  \*************************************************************************************************************************************************/
...
/***/ 232:
/*!*******************************************************************************************************************************!*\
  !*** C:/Gongzuo/XiaoChengXu/ZhiFuBao/Zjkj/pages/makeAppointmentRegister/makeAppointmentRegister.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__(/*! ./makeAppointmentRegister.scss */ 234);
...
var _default = { // 调用头部组件
  components: {// header
      ...
      checkday: "", baseUrl: _base.default.sq, deptInfo: {}, isShowDate: true, today: new Date(), weeks: [], days: [], selectDay: 0, selectDayInfo: {}, selectDayIndex: 0, doctors: [], doctor: {}, isShowConfirm: false, feeBill: {}, deptbill: { begin: "2021/11/25 8:00:00", deptID: "0008", deptName: "眼门", docID: "200328", docName: "曲建军", end: "2021/11/25 10:50:00", iD: "216608", noonID: new Date().getHours() < 12 ? "1" : "2", regLevelID: "1", regLevelName: "普诊", seeNO: "0", totalFee: "8", testDay: "" }, showSwitchPatient: true, deptId: "", isShowText: true, // 控制内容显示
      keshiname: '' //科室名称
    };}, // 在uniapp中如果要使用路由传参必须使用onload(路由传参中的参数值)
  onLoad: function onLoad(e) {console.log(e);this.deptId = e.id;console.log(this.deptId);this.jiazai();}, methods: { // 加载框
    jiazai: function jiazai() {var _this = this;this.loading = true; // 定时器，setTimeout只执行一次，setInterval执行多次
      setTimeout(function () {_this.loading = false;console.log(_this.loading);}, 500);}, // 控制动画的方法
    showMore: function showMore() {var _this2 = this; //获取当前时间的时间戳
      ...
      if (this.lastTime == 0) {console.log('触发事件'); // 控制显示
        ...
        if (this.isShowText) {setTimeout(function () {_this2.isShowText = !_this2.isShowText;}, 100);} else {setTimeout(function () {_this2.isShowText = !_this2.isShowText;}, 900);}this.lastTime = now;} else {if (now - this.lastTime > 2000) {//重置上一次点击时间，2000是我自己设置的2秒间隔，根据自己的需要更改
          ...
          if (this.isShowText) {setTimeout(function () {_this2.isShowText = !_this2.isShowText;}, 100);} else {setTimeout(function () {_this2.isShowText = !_this2.isShowText;}, 900);}this.lastTime = now;console.log('间隔大于2秒，触发方法'); //添加自己要调用的方法
        } else {uni.showToast({ title: '点的太快啦！QAQ', icon: 'none', duration: 2000 });console.log('不触发');}}}, // // 控制动画的方法
    // showMore() {
    // 	// 控制显示
    ...
    // 	}
    // },
    getDetDoctorInfo: function getDetDoctorInfo() {this.doctors = [];this.testDay = this.today.getFullYear() + "-" + (this.today.getMonth() < 10 ? "0" + (this.today.getMonth() + 1) : this.today.getMonth() + 1) + "-" + this.selectDay;var params = { beginDay: this.selectDayInfo.year + "-" + (this.selectDayInfo.month < 10 ? "0" + this.selectDayInfo.month : this.selectDayInfo.month) + "-" + this.selectDayInfo.day, deptId: this.deptId //endDay: this.today.getFullYear() + (this.today.getMonth() < 10 ? '0'+(this.today.getMonth() + 1) : (this.today.getMonth() + 1)) + this.selectDay
      };console.log(params);var dataInfo = { inParams: '{"NoonCode":"2","DeptID":"0008","Date":"2022-06-21"}', doctorInfo: [{ begin: "2022/6/21 11:15:00", deptID: "0008", deptName: "眼门", docID: "200092", docName: "唐麟", end: "2022/6/21 14:40:00", iD: "222044", noonID: "2", regLevelID: "1", regLevelName: "普诊", seeNO: "0" }, { begin: "2022/6/21 12:50:00", deptID: "0008", deptName: "眼门", docID: "200099", docName: "董翠翠", end: "2022/6/21 16:30:00", iD: "222046",
          noonID: "2",
          regLevelID: "1",
          regLevelName: "普诊",
          seeNO: "0" },
...
/***/ 235:
/*!***************************************************************************************************************************************************************!*\
  !*** C:/Gongzuo/XiaoChengXu/ZhiFuBao/Zjkj/pages/makeAppointmentRegister/makeAppointmentRegister.vue?vue&type=style&index=0&id=32631430&scoped=true&lang=css& ***!
  \***************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
